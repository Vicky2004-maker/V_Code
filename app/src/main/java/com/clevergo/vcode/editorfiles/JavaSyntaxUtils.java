...
public class JavaSyntaxUtils {
    ...
    public static void applyMonokaiTheme(Context context, CodeView codeView) {
        ...
        codeView.addSyntaxPattern(PATTERN_COMMENT, context.getResources().getColor(R.color.grey));
        codeView.addSyntaxPattern(PATTERN_ANNOTATION, context.getResources().getColor(R.color.red));
        codeView.addSyntaxPattern(PATTERN_ATTRIBUTE, context.getResources().getColor(R.color.blue));
        codeView.addSyntaxPattern(PATTERN_GENERIC, context.getResources().getColor(R.color.red));
